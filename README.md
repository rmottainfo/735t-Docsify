...
O processo de implementação do Docsify é simples e rápido porque ele não exige compilação (*build*). O site é gerado diretamente no navegador a partir dos seus arquivos Markdown.
